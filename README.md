...
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/ja-ko/ppoker/ci.yml)
...
* [Linux](https://github.com/ja-ko/ppoker/releases/download/v0.6.0/ppoker-x86_64-unknown-linux-gnu.tar.gz)
* [Windows](https://github.com/ja-ko/ppoker/releases/download/v0.6.0/ppoker-x86_64-pc-windows-msvc.zip)
* [Mac](https://github.com/ja-ko/ppoker/releases/download/v0.6.0/ppoker-x86_64-apple-darwin.tar.gz)
